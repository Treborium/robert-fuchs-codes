...
export default function MobileApp(): JSX.Element {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', backgroundColor: backgroundColor, height: '100vh', width: '100vw', border: 'none' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-evenly', alignItems: 'stretch', height: '100vh',  padding: '0 3vw' }}>
